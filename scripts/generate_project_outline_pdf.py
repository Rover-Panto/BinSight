"""Archived generator for the superseded early project outline.

Do not use this script to describe the current BinSight architecture. The current
proposal is generated by ``create_binsight_proposal.py`` and separates two bin
types: general-waste bins use fill sensing only, while the recycling-return
station is the sole vision-enabled device.
"""

...
def run_tests() -> None:
    ...
    """
    print_banner("1. RUNNING MODEL PIPELINE SANITY TESTS (v2.0 - 32 TESTS)")
    ...
    tests = [
        ...
        ("Reject Unsupported Threshold & Keep ID", test_reject_unsupported_threshold),
        ...
        ("Model Unavailable Before Selection Cutoff", test_model_unavailable_before_training_cutoff),
        ("Timezone Offset Equivalence", test_timezone_offset_equivalence),
        ("Stale History Detection", test_stale_history_returns_stale_status),
        ("Stale Single Reading Detection", test_stale_single_reading_returns_stale_not_cold_start),
        ...
        ("Incompatible Dependency Rejection", test_incompatible_dependency_version_rejected_before_load),
        ...
        ("Default Model Bundle Loading", test_default_model_bundle_loads_without_explicit_path),
        ("Four Waste Types Preserved", test_four_waste_types_preserved),
        ("All-Low-Confidence Status", test_all_low_confidence_history_returns_low_confidence_status),

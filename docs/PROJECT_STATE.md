...
The latest review covers PR1 `8b34c96`, PR2 `84952d2`, PR3 `819ff37` and PR4 `28509cc`. PR2 has a newer push awaiting review. PR4's 32 tests and fresh wheel install pass, but independent checks still find invalid-manifest, sensor-quality and observation-timezone failures; training and packaged model paths also need a promotion check. None of these PRs has been staged or merged into main. See [the current review](INTEGRATION_REVIEW_LATEST.md) and [PR4's dated evidence](PR4_REVIEW_2026-08-29.md).

...
These are engineering-development corrections, not confirmatory hypothesis testing. `FINAL_RESULTS.md` is the historical v1 lock; `DYNAMIC_V2_RESULTS.md` is the versioned v2 comparison. Neither is measured field performance.
